...
import cube.runtime.am.impl.AutonomicManagerImpl;
import cube.runtime.util.perf.PerformanceChecker;
...
public class CubeRuntime implements AdministrationService {
     ...
     * Extension Factories
     */
    @Requires(specification="cube.runtime.extensions.ExtensionFactoryService",optional = true)
    private List<ExtensionFactoryService> extensionFactories;


    //@Requires(specification = "cube.runtime.extensions.CommunicatorExtensionPoint")
