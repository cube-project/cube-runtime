 ...
 * Time: 2:07 AM
 */
public class HasComponentId extends AbstractUnaryResolver {

    public HasComponentId(Extension extension) {
        super(extension);
    }
    ...
    public boolean check(ManagedElement me, String value) {
        if (me != null && value != null) {
            String ct = me.getAttribute(Component.CORE_COMPONENT_ID);
    ...
    public boolean perform(ManagedElement me, String value) {
        if (me != null && value != null) {
            if (me.getAttribute(Component.CORE_COMPONENT_ID) == null) {
                try {
                    me.addAttribute(Component.CORE_COMPONENT_ID, value);
                    return true;
                ...
                try {
                    me.updateAttribute(Component.CORE_COMPONENT_ID, value);
                    return true;
