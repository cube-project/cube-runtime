 ...
 * Time: 2:07 AM
 */
public class HasNodeType extends AbstractUnaryResolver {

    public HasNodeType(Extension extension) {
        super(extension);
    }
    ...
    public boolean check(ManagedElement me, String value) {
        if (me != null && value != null) {
            String ct = me.getAttribute(Node.CORE_NODE_TYPE);
    ...
    public boolean perform(ManagedElement me, String value) {
        if (me != null && value != null) {
            if (me.getAttribute(Node.CORE_NODE_TYPE) == null) {
                try {
                    me.addAttribute(Node.CORE_NODE_TYPE, value);
                    return true;
                ...
                try {
                    me.updateAttribute(Node.CORE_NODE_TYPE, value);
                    return true;
