 ...
 * Time: 2:07 AM
 */
public class HasNodeId extends AbstractUnaryResolver {

    public HasNodeId(Extension extension) {
        super(extension);
    }
    ...
    public boolean check(ManagedElement me, String value) {
        if (me != null && value != null) {
            String ct = me.getAttribute(Node.CORE_NODE_ID);
    ...
    public boolean perform(ManagedElement me, String value) {
        if (me != null && value != null) {
            if (me.getAttribute(Node.CORE_NODE_ID) == null) {
                try {
                    me.addAttribute(Node.CORE_NODE_ID, value);
                    return true;
                ...
                try {
                    me.updateAttribute(Node.CORE_NODE_ID, value);
                    return true;
